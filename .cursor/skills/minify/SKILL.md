...
name: minify
description: >-
  Regenerates src/troy-server/library/js/*.min.js and
  src/troy-server/library/css/*.min.css via babel-tsf and cleancss-tsf. Use
  after editing unminified library/js or library/css sources, or when the user
  asks to minify. Do not hand-edit min files.
---
# Minify Troy Server JS and CSS
