/**
 * Minifies all JS and CSS source files in src/troy-server/library/.
 *
...
const LIB_DIR         = path.resolve( ROOT, 'src', 'troy-server', 'library' );
...
/**
 * Runs JS and CSS minification for src/troy-server/library/.
 */
async function main() {
