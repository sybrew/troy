...
<p align="center">
	<a href="https://deploytroy.org/docs/developers/quick-start/">Quick Start</a> · <a href="https://deploytroy.org/docs/"><strong>Documentation</strong></a> · <a href="https://deploytroy.org/changelogs/"><strong>Changelog</strong></a> · <a href="https://deploytroy.org/roadmap/"><strong>Roadmap</strong></a>
</p>
...
Troy is an open-source project maintained by [Sybre Waaijer](https://github.com/sybrew/). If you find any issues or have suggestions, please [open an issue](https://github.com/sybrew/troy/issues) or [start a discussion](https://github.com/sybrew/troy/discussions).
...
- [Troy Installer](#troy-installer): A simple installer plugin that installs Troy Client and vendor plugins on your WordPress site. Troy Server can generate this installer for you to distribute to your clients.
- [Troy Client Snippets](#troy-client-snippets): Code snippets to customize or embed Troy Client functionality.

## Troy Server

Troy Server is a WordPress plugin that allows you to host your own plugin repository, which can be used to distribute plugins and their dependencies to your clients. Themes will also be supported in the future.
...
Troy Server has "up-to-date" server requirements, but nothing too special. You must use MySQL 8.0.19 or higher, or MariaDB 10.5 or higher. Troy Server tables must use InnoDB so database transactions can roll back package and stats writes safely. You must also use PHP 8.4 or higher and WordPress 6.8 or higher. We recommend running this on a server that can handle Pong. The update service is ridiculously optimized. For the webserver we recommend using Apache, since it is faster at handling PHP requests than Nginx.
...
<small><strong>Planned:</strong> Troy Server will support themes in the future, allowing you to distribute themes alongside plugins. The theme management interface will be similar to the plugin management interface, with options to upload theme ZIP files or connect to GitHub or WordPress.org repositories for automatic updates.</small>
